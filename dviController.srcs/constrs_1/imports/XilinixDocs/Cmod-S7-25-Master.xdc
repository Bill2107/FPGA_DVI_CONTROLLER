...
#create_clock -period 25.000 -name pixelClk -waveform {0.000 12.500} [get_ports -filter { NAME =~  "*" && DIRECTION == "IN" }]
...
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { VSYNC }]; #IO_L7N_T1_D10_14 Sch=pio[26]
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { HSYNC }]; #IO_L4P_T0_D04_14 Sch=pio[27]
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { VGA_DISP[0] }]; #IO_L5P_T0_D06_14 Sch=pio[28]
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { VGA_DISP[1] }]; #IO_L7P_T1_D09_14 Sch=pio[29]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { VGA_DISP[2] }]; #IO_L8P_T1_D11_14 Sch=pio[30]
